...
포지션 : Back-end developer. (Back office, Admin, etc.)

# 요약

Java 기반의 Back-end 개발자입니다. 패션, 보험, 금융, 통신, 공공 분야의 다양한 개발 프로젝트에 참여했었으며, 현재 근무하는 패션 분야에서는 CS, 물류, 마케팅, 영업, 기획, 데이터의 각 파트 실무자로부터 의견을 취합하여 기존 프로세스의 문제를 분석하고, 백오피스(back-office)의 업무프로세스를 개선하여 매출 증대에 많은 기여를 했습니다. 새로운 기술학습에 대한 두려움이 없으며, 플랫폼 개선에 대한 고민을 각 팀원들과 공유하는 것을 좋아합니다. 지금은 잃어버린 기초 지식을 다시 학습하기 위해 알고리즘 및 자료구조에 관심이 있습니다. 지금 하고 있는 일에 매우 만족합니다. 지금 하고 있는 일에 매우 만족합니다.

# 주요역량

  - 비즈니스 분석 및 신속한 개발 환경 적응
    - 다양한 프로젝트에서 경험한 개발 환경에서의 경험을 바탕으로 새로운 개발 환경에 빠르게 적응하여 업무를 수행함.
    - 팀원들과의 커뮤니케이션, 코드 및 문서를 통한 비즈니스 분석이 빠름.
    - 데이터의 흐름을 이해하여 프로세스를 개선할 수 있는 방법을 도출하고, 이를 개선하여 적용하는데 능숙함.


  - 품질향상에 대한 고민해결
    - 발생할 수 있는 다양한 경우의 수를 고민하고, 테스트하여 문제를 찾아 해결하여 서비스에 적용하는 것을 즐김.
    - 사용자의 입장에서 만족할 수 있는 서비스 개발을 위해 고민하고 해결방법을 찾는 것을 즐김.


  - 기억보다 기록
    - 발생한 이슈에 대한 원인 분석, 해결방안 고민, 처리내용을 문서화하여 함께 공유하고 재발 방지.
    - 불편한 부분을 기록하여 서비스 품질 개선에 활용.
    - 새로운 내용을 기록하고 팀원들과 공유하여 함께 성장.
...
## ㈜더클로젯컴퍼니 
  ...
  - 2020.03 ~ 현재
    - 플랫폼 개발 및 운영   
    (담당업무 : 상품, 프라이싱, 셰어링)
    - 백오피스 신규 기능 개발 및 개선, 버그 수정
    - CS, MD, 마케팅, 물류, Data팀 운영업무 지원

## ㈜리치앤코  
  - 개발팀 - 과장/팀원
  - 2018.02 ~ 2020.03
    - 자회사 CRM 시스템 개발 및 운영   
      (담당업무 : 회원, 권한, 상담, 콜, 통계, 정산)
    - 권한관리시스템 개발 및 운영
    - 영업, 마케팅 운영업무 지원

## 프리랜서
  - 2013.07 ~ 2018.01
    - 녹취 어드민 시스템 개발 및 운영 (동방정보통신)   
    (담당업무 : 업체별 요구사항 분석/개발/배포, API 연계구축, Web Security 적용, 산출물 작성, 사용자 교육)
    - 유전자 관리시스템 고도화 (농촌진흥청)
    - 사용자 인증 API 개발 (SK C&C)
    - 날씨 어드민 시스템 개발 및 운영 (SK Planet)

## ㈜트라이언소프트 
  - 개발팀 - 대리/팀원
  - 2013.02 ~ 2013.06
    - 아이돌봄 프로젝트 고도화 개발 참여
    - 행복e음 API 연계 및 운영업무 지원
    - GPKI 공인인증서 로그인 및 실명인증 개선
    - 프로젝트 산출물 작성
...
[경력기술서.pdf](https://drive.google.com/file/d/1dTEnZKZGLh5CsJKCLXJoCdQb6YqPXDRx/view)
   
***
   
# About

I am a Java-based back-end developer. I have been involved in various development projects in the fashion, insurance, finance, telecommunications, public sector and fashion sectors. I collected existing process issues from CS, logistics, marketing, sales, planning, and data team practitioners to analyze business processes and improve our back office to increase sales significantly. I'm not afraid to learn new skills and I love to share my opinions on improving the platform with each team member. Currently, I'm interested in skills and knowledge related to recommendation algorithms that can maximize user experience through data analysis.
